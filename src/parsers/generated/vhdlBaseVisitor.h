...
public:
  ...
  virtual antlrcpp::Any visitName_function_call_or_indexed_part(vhdlParser::Name_function_call_or_indexed_partContext *ctx) override {
    return visitChildren(ctx);
  }
  ...
  virtual antlrcpp::Any visitRange_(vhdlParser::Range_Context *ctx) override {
    return visitChildren(ctx);
  }
