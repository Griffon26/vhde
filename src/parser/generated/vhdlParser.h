...
public:
  ...
  enum {
    ...
    RuleName_attribute_part = 148, RuleName_function_call_or_indexed_part = 149, 
    RuleName_slice_part = 150, RuleSelected_name = 151, RuleNature_declaration = 152, 
    RuleNature_definition = 153, RuleNature_element_declaration = 154, RuleNext_statement = 155, 
    RuleNumeric_literal = 156, RuleObject_declaration = 157, RuleOpts = 158, 
    RulePackage_body = 159, RulePackage_body_declarative_item = 160, RulePackage_body_declarative_part = 161, 
    RulePackage_declaration = 162, RulePackage_declarative_item = 163, RulePackage_declarative_part = 164, 
    RuleParameter_specification = 165, RulePhysical_literal = 166, RulePhysical_type_definition = 167, 
    RulePort_clause = 168, RulePort_list = 169, RulePort_map_aspect = 170, 
    RulePrimary = 171, RulePrimary_unit = 172, RuleProcedural_declarative_item = 173, 
    RuleProcedural_declarative_part = 174, RuleProcedural_statement_part = 175, 
    RuleProcedure_call = 176, RuleProcedure_call_statement = 177, RuleProcess_declarative_item = 178, 
    RuleProcess_declarative_part = 179, RuleProcess_statement = 180, RuleProcess_statement_part = 181, 
    RuleQualified_expression = 182, RuleQuantity_declaration = 183, RuleQuantity_list = 184, 
    RuleQuantity_specification = 185, RuleRange_ = 186, RuleExplicit_range = 187, 
    RuleRange_constraint = 188, RuleRecord_nature_definition = 189, RuleRecord_type_definition = 190, 
    RuleRelation = 191, RuleRelational_operator = 192, RuleReport_statement = 193, 
    RuleReturn_statement = 194, RuleScalar_nature_definition = 195, RuleScalar_type_definition = 196, 
    RuleSecondary_unit = 197, RuleSecondary_unit_declaration = 198, RuleSelected_signal_assignment = 199, 
    RuleSelected_waveforms = 200, RuleSensitivity_clause = 201, RuleSensitivity_list = 202, 
    RuleSequence_of_statements = 203, RuleSequential_statement = 204, RuleShift_expression = 205, 
    RuleShift_operator = 206, RuleSignal_assignment_statement = 207, RuleSignal_declaration = 208, 
    RuleSignal_kind = 209, RuleSignal_list = 210, RuleSignature = 211, RuleSimple_expression = 212, 
    RuleSimple_simultaneous_statement = 213, RuleSimultaneous_alternative = 214, 
    RuleSimultaneous_case_statement = 215, RuleSimultaneous_if_statement = 216, 
    RuleSimultaneous_procedural_statement = 217, RuleSimultaneous_statement = 218, 
    RuleSimultaneous_statement_part = 219, RuleSource_aspect = 220, RuleSource_quantity_declaration = 221, 
    RuleStep_limit_specification = 222, RuleSubnature_declaration = 223, 
    RuleSubnature_indication = 224, RuleSubprogram_body = 225, RuleSubprogram_declaration = 226, 
    RuleSubprogram_declarative_item = 227, RuleSubprogram_declarative_part = 228, 
    RuleSubprogram_kind = 229, RuleSubprogram_specification = 230, RuleProcedure_specification = 231, 
    RuleFunction_specification = 232, RuleSubprogram_statement_part = 233, 
    RuleSubtype_declaration = 234, RuleSubtype_indication = 235, RuleSuffix = 236, 
    RuleTarget = 237, RuleTerm = 238, RuleTerminal_aspect = 239, RuleTerminal_declaration = 240, 
    RuleThrough_aspect = 241, RuleTimeout_clause = 242, RuleTolerance_aspect = 243, 
    RuleType_declaration = 244, RuleType_definition = 245, RuleUnconstrained_array_definition = 246, 
    RuleUnconstrained_nature_definition = 247, RuleUse_clause = 248, RuleVariable_assignment_statement = 249, 
    RuleVariable_declaration = 250, RuleWait_statement = 251, RuleWaveform = 252, 
    RuleWaveform_element = 253
  };
